...
\begin{itemize}
    ...
    \item \en{Decision Tree}: \gr{Η συνάρτηση} \en{decision\_tree} \gr{χρησιμοποιεί τον αλγόριθμο} \en{Decision Tree} \gr{για την κατηγοριοποίηση των δεδομένων. Το μοντέλο εκπαιδεύεται και οπτικοποιείται το} \en{decision tree} \gr{για να εμφανιστεί πώς λαμβάνονται οι αποφάσεις.}

    \item \en{Random Forest}: \gr{Η συνάρτηση} \en{`random\_forest`} \gr{εφαρμόζει τον αλγόριθμο} \en{Random Forest} \gr{, ο οποίος συνδυάζει πολλά} \en{decision trees} \gr{για να βελτιώσει την ακρίβεια της κατηγοριοποίησης. Ο αλγόριθμος οπτικοποιεί ένα από τα δέντρα του δάσους για ανάλυση.}
\end{itemize}
...
\gr{Παρακάτω εξηγείται πώς χρησιμοποιούμε την εφαρμογή. Κατά την είσοδο στην εφαρμογή, ο χρήστης έρχεται σε επαφή με το} \en{UI,} \gr{το οποίο περιλαμβάνει ένα widget για ανέβασμα αρχείων, καθώς και ένα} \en{sidebar menu } \gr{που χρησιμοποιεί για να περιηγηθεί στην εφαρμογή.}
